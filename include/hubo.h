...
#define         HUBO_REF_FILTER_LENGTH   250      ///> filter length for reference (mode 0)
...
struct hubo_ref {
	...
	int mode[HUBO_JOINT_COUNT]; ///< joint mode  0 = filtered, 1 = direct ref
